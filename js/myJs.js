...
function firstQuestion(){
    ...
    $('.content').hide();
    Swal.fire({
        title: 'Hello Bạn gì đó dễ thương cute ơiiii :>>>>',
        text: 'Hôm nay mình có chuyện quan trọng muốn nói với cậu, trả lời thật lòng nhaaaaa.',
...
function textGenerate() {
    var n = "";
    var text = " Tại vì cậu rất là dễ thương, lại còn tốt bụng nữa...:>";
    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                ...
                onClose: () => {
                    window.location = 'https://www.instagram.com/anhdang438/';
                  }
            })
        }
    })
